...
<head>
  ...
  <title>Dashboard Mahasiswa - Wellness Mission</title>
...
<body style="background-color: #f2f2f2;">
    ...
    <div class="container-fluid px-4">
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
        ...
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item"><a class="nav-link active" href="wellnessmission.php">Wellness Mission</a></li>
        </ul>
  ...
  <main class="container-fluid py-5" style="margin-top: 60px;">
    <div class="p-5 bg-white rounded shadow-sm">
      <p class="text-muted">Ini area konten utama untuk fitur wellness mission (Mahasiswa).</p>
    </div>
  </main>
